...
export const LogGetBank = (props) => {
    ...
    const getLogMachineIOTAll = async () =>{
      ...
      const res =  await Database.GetLogDataTransaction(moment(dateDefault).format('YYYY-MM-DD'))
...
export default connect(mapStateToProps, mapDispatchToProps)(LogGetBank)

  ...
  return (
    <Container>
      ...
      <p>
        ...
        (“Personal Information”) in the “Image Wash” mobile application (“Mobile
      ...
      <p>
        ...
        “your”) and this Mobile Application developer (“Operator”, “we”, “us” or
        ...
        accept this agreement and may not access and use the Mobile Application
        and Services. By accessing and using the Mobile Application and
        Services, you acknowledge that you have read, understood, and agree to
        be bound by the terms of this Policy. This Policy does not apply to the
        practices of companies that we do not own or control, or to individuals
        that we do not employ or manage. This privacy policy was created with
        the help of the{' '}
        <a
          target='_blank'
      ...
      <p>
        ...
        search for in the Mobile Application, access times and dates, and other
        statistics.
      </p>
      <p>
      ...
      <p>
        ...
        could identify you as a specific, identifiable individual. If, however,
        you wish to use some of the features offered in the Mobile Application,
        you may be asked to provide certain Personal Information (for example,
        your name and e-mail address).
      </p>
      <p>
        We receive and store any information you knowingly provide to us when
        you create an account, or fill any forms in the Mobile Application. When
      ...
      <p>
        ...
        Personal Information through the Mobile Application and Services. If you
        have reason to believe that a child under the age of 13 has provided
        Personal Information to us through the Mobile Application and Services,
      ...
      <p>
        ...
        Application and Services without their permission. We also ask that all
      ...
      <p>
        ...
        Personal Information through the Mobile Application and Services. We do
        ...
        accordance with your instructions. In such instances, the User providing
      ...
      <p>
        ...
        or services. Any of the information we collect from you may be used for
      ...
      <p>
        ...
        the Mobile Application and Services, where you are located in the world
        and if one of the following applies: (i) you have given your consent for
        one or more specific purposes; (ii) provision of information is
        ...
        and update our Mobile Application and Services.
      </p>
      <p>
        {' '}
      ...
      <p>
        ...
        however, we may maintain a copy of the unrevised Personal Information in
        our records for the duration necessary to comply with our obligations to
        our affiliates and partners, and for the purposes described below. If
        you would like to delete your Personal Information or permanently delete
      ...
      <p>
        ...
        the operation of the Mobile Application and Services available to you
      ...
      <p>
        ...
        account remains active, to enforce our agreements, resolve disputes, and
      ...
      <p>
        Our Mobile Application and Services may use third-party analytics tools
        that use cookies, web beacons, or other similar information-gathering
        ...
        reports on User activity such as how often Users visit our Mobile
        Application and Services, what pages they visit and for how long, etc.
        We use the information obtained from these analytics tools to monitor
        the performance and improve our Mobile Application and Services. We do
        not use third-party analytics tools to track or to collect any
        personally identifiable information of our Users and we will not
        associate any information gathered from the statistical reports with any
        individual User.
      </p>
      ...
      <p>
        ...
        responsible for the privacy practices of such other resources or third
        parties. We encourage you to be aware when you leave the Mobile
        Application and Services and to read the privacy statements of each and
      ...
      <p>
        ...
        the Mobile Application and Services cannot be guaranteed; and (iii) any
      ...
      <p>
        ...
        and Services has been compromised or Users’ Personal Information has
        ...
        law. When we do, we will post a notice in the Mobile Application, send
        you an email.
      </p>
      ...
      <p>
        ...
        use of the Mobile Application and Services after the effective date of
      ...
      <p>
        ...
        Services and submitting your information you agree to be bound by this
        Policy. If you do not agree to abide by the terms of this Policy, you
        are not authorized to access or use the Mobile Application and Services.
      </p>
      <h2>Contacting us</h2>
      <p>
      ...
      <p>
        <a target='_blank' rel='nofollow' href='https://www.image-wash.com'>
          https://www.image-wash.com
        </a>
      </p>
      <p>
      ...
      <p>This document was last updated on March 11, 2022</p>
    </Container>
  )
}
